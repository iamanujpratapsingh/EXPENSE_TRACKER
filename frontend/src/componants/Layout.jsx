...
import {
    ArrowDown, ArrowUp, Car, ChevronDown, ChevronUp, Clock, CreditCard,
    DollarSign, Gift, Home, Info, PiggyBank, RefreshCw, ShoppingCart,
    TrendingUp, Utensils, Zap, Activity, PieChart
} from 'lucide-react';
            ...
            <div className={styles.layout.mainContainer(sidebarCollapsed)}>
                <div className={styles.header.container}>
                    <div>
                        ...
                        <p className={styles.header.subtital}>Welcome back</p>
                    </div>
                ...
                <div className={styles.grid.main}>
                    <div className={styles.grid.leftColumn}>
                        <div className={styles.grid.base}>
                            <div className={styles.grid.header}>
                                <h3 className={styles.cards.tital}>
                    ...
                    <div className={styles.grid.rightColumn}>
                        ...
                        <div className={styles.cards.base}>
                            ...
                            <div className={styles.categories.summryContainer}>
                                <div className={styles.categories.summaryGrid}>
                                    <div className={styles.categories.summryIncomeCard}>
                                        <p className={styles.categories.summryTitle}>
                                            Total Income
                                        </p>
                                        <p className={styles.categories.summryValue}>
