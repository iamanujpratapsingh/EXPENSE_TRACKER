...
import FinancialCard from "../componants/FinancialCard";
import GaugeCard from "../componants/GaugeCard";
import AddTransactionModal from "../componants/Add";
    ...
    return (
        <div className={dashboardStyles.container}>
            <div className={dashboardStyles.headerContainer}>
                <div>
                    <h1 className={dashboardStyles.headerTital}>Finance Dashboard</h1>
            ...
            <div className={dashboardStyles.summaryGrid}>
                <FinancialCard
                    ...
                    additionalContent={
                        <div className="flex items-center gap-2 mt-2 text-sm">
                            <span className={dashboardStyles.balanceBdge}>
                ...
                <FinancialCard
                    ...
                    additionalContent={
                        <div
                            className={`mt-2 text-xm flex items-center gap-1 ${expenseChange >= 0 ? trendStyles.positive : trendStyles.negative
                                }`}
                        >
                            {expenseChange >= 0 ? (
                ...
                <FinancialCard
                    ...
                    value={`$${Math.round(displaySavings).toLocaleString()}`}
                    additionalContent={
                        <div className="mt-2 text-xm text-cyan-600 flex items-center gap-2">
