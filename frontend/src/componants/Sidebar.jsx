...
import { Home, ArrowUp, ArrowDown, User, HelpCircle, Menu, X, LogOut, MessageCircle, FileText } from 'lucide-react';
...
const Sidebar = ({ user, isCollapsed, setIsCollapsed }) => {
    ...
    const [showSupportMenu, setShowSupportMenu] = useState(false);   // ← new line for contact via whatshapp
                    ...
                    <button onClick={toggleSidebar} className={sidebarStyles.toggleButton.base}>
                        ...
                        >
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round">
                                <polyline
                                    points={isCollapsed ? "9 18 15 12 9 6" : "15 18 9 12 15 6"}></polyline>
                            </svg>
                        </motion.div>
                        ...
                        <div className=" flex items-center">
                            ...
                            {!isCollapsed && (
                                ...
                                >
                                    ...
                                    <p className=" text-xm text-gray-500 truncate">
                                        {email}
                                    </p>
                                </motion.div>
                            )}
                            ...
                            <AnimatePresence>
                                {showSupportMenu && (
                                    <motion.div
                                        ...
                                        exit={{ opacity: 0, y: 8 }}
                                        className="absolute bottom-full mb-2 left-0 w-48 bg-white border border-gray-200 rounded-lg shadow-lg overflow-hidden z-50"
                                    >
                                        <Link
                                            to="/support"
                                        ...
                                        <a
                                            href="https://wa.me/919580155491?text=Hi%2C%20I%20need%20help%20with%20ExpenseTracker"
                                            target="_blank"
                                        ...
                                        <AnimatePresence>
                                            {showSupportMenu && (
                                                ...
                                                >
                                                    <Link
                                                        to="/support"
                                                        onClick={() => { setShowSupportMenu(false); setMobileOpen(false); }}
                                                        className="flex items-center gap-2 px-4 py-3 text-sm text-gray-700 hover:bg-gray-50 transition-colors"
                                                    >
                                                        <FileText size={16} className="text-blue-500" />
                                                        Contact Form
